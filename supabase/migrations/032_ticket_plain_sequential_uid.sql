-- Migration 032: plain sequential ticket IDs.
-- Tickets should display as 0001, 0002, ... with no date suffix.
...
SET ticket_uid = public.format_order_ticket_uid(numbered.ticket_no)
FROM numbered
